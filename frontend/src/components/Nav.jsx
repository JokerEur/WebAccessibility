    ...
    <div className='shadow bg-white-100 dark:bg-gray-700'>
      <div className="nav fixed min-h-[70px] flex items-center z-30  dark:bg-slate-800">  
        ...
        {name&&
            ...
            {products&&
              <div className='min-w-max flex items-center mr-auto'>
                {products.category_id&& 
                  <div className='ml-2 w-max inline-block'>
                  /
                  <Link to={'/'+products.category_id} className='mx-2'>
                  {categories.find(categorys => categorys.id == products.category_id).name} 
                  </Link>
                  </div>
                }
                {products.product_name&& 
                <h7 className='font-normal truncate inline-block  m-0 max-w-[700px]'>
                / {products.product_name} 
              </h7>
        ...
        <div className=' mx-3'>
          <Link to='/cart' className='rounded-lg focus:text-xl focus:font-bold focus:text-blue-800' >
